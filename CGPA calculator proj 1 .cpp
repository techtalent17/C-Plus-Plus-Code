/*This C++ PROGRAM is developed by Md. Al Amin YT,and
special right is given to techtalent17.com for educational purpose  */
...
int main()
{
    ...
    int input;
    cout<<"---------------------------------------------------------------------------"<<endl;
    cout<<"                    GPA & CGPA Calculator (Developed by Al Amin)             "<<endl;
    cout<<"--------------------------------------------------------------------------\n"<<endl;
    cout<<"            MENU:"<<endl;
